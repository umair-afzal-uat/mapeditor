	...
	public function wfacp_options_page_right_content() {
        ...
        <div class="postbox wfacp_side_content wfacp_allow_panel_close">
            ...
            <div class="inside">
				...
				), 'https://buildwoofunnels.com/docs/checkout-pages/getting-started/' );
				...
				), 'https://buildwoofunnels.com/docs/checkout-pages/getting-started/creating-first-checkout-page/' );
				$global_checkout   = add_query_arg( array(
					'utm_source'   => 'wfacp-pro',
					'utm_medium'   => 'text-click',
					'utm_campaign' => 'resource',
					'utm_term'     => 'global-checkout-page',
				), 'https://buildwoofunnels.com/docs/checkout-pages/getting-started/replace-default-checkout' );
				$doc_link          = add_query_arg( array(
					'utm_source'   => 'wfacp-pro',
					'utm_medium'   => 'text-click',
					'utm_campaign' => 'resource',
					'utm_term'     => 'documentation',
				), 'https://buildwoofunnels.com/docs/checkout-pages/' );
