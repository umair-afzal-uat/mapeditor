...
$apply_coupon_button_text = apply_filters( 'wfacp_form_apply_coupon_button_text', __( 'Apply coupon', 'woocommerce' ) );
?>
        ...
        <div class="wfacp-coupon-page">
            ...
            <div class="wfacp-row wfacp_coupon_field_box" style="<?php echo ( wc_string_to_bool( $is_collapsible ) && count( WC()->cart->applied_coupons ) == 0 ) ? 'display:none' : ''; ?>">
                ...
                <p class="form-row form-row-last <?php echo $coupon_cls; ?> wfacp_coupon_btn_wrap">
                    <button type="button" class="button wfacp-coupon-field-btn" name="apply_coupon" value="<?php  echo $apply_coupon_button_text; ?>"><?php  echo $apply_coupon_button_text; ?></button>
                </p>
                <div class="clear"></div>
            </div>
            <div class="wfacp-row ">
