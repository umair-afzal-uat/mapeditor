...
class WFACP_Compatibility_WC_Affirm {
	...
	public function action() {
		...
		$intance = WFACP_Common::remove_actions( 'woocommerce_checkout_after_order_review', 'WooCommerce_Gateway_Affirm', 'inline_checkout' );


		if ( $intance instanceof WooCommerce_Gateway_Affirm ) {

			$intance->inline_checkout();
		}
	}
