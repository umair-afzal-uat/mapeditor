...
class WFACPKirki_Modules_Icons {
	...
	public function customize_controls_enqueue_scripts() {
		...
		wp_enqueue_script( 'wfacpkirki_panel_and_section_icons', trailingslashit( WFACPKirki::$url ) . 'modules/icons/icons.js', array( 'jquery', 'customize-base', 'customize-controls' ), WFACP_VERSION, true );
