...
class WFACPKirki_Modules_Custom_Sections {
	...
	public function enqueue_scrips() {
		...
		wp_enqueue_script( 'wfacpkirki-custom-sections', trailingslashit( WFACPKirki::$url ) . 'modules/custom-sections/sections.js', array( 'jquery', 'customize-base', 'customize-controls' ), WFACP_VERSION );
