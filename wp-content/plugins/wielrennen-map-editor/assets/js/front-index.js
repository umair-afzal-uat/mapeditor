...
jQuery(document).ready(function($) {
	$(document).on('click','.custom-design, .materials, .framed_list, .scheme', function() {
		...
		console.log(custom_design);
		console.log(materials);
		console.log(framed_list);
		console.log(scheme_color);
...
function design_load_framed_poster(framed_poster) {
	...
	return new Promise(async function(resolve, reject) {
		...
		try {
			...
			browser_class(['framed_poster', framed_poster.type,].join('-'));
			...
			$group.find('a.item').filter('[data-design-value=' + framed_poster.type + ']').addClass('active');
