jQuery(document).ready(function($) {
	...
	$(document).on('click','.wie_download_pdf',function() {
		...
		var map_frame_poster = document.createElement('section');
		
	
console.log(design_map);
		...
		if(design_map.layer.framed_poster.poster == 'wood') {
			map_outline.style.backgroundImage =  "url('../wp-content/plugins/wielrennen-map-editor/assets/images/outline/"+design_map.layer.outline.type+"/wood_"+new_size+"_"+design_map.paper.orientation+".svg')";

		} else if(design_map.layer.framed_poster.poster == 'white') {
			map_outline.style.backgroundImage =  "url('../wp-content/plugins/wielrennen-map-editor/assets/images/outline/"+design_map.layer.outline.type+"/white_"+new_size+"_"+design_map.paper.orientation+".svg')";

		} else if (design_map.layer.framed_poster.poster == 'black') {
			map_outline.style.backgroundImage =  "url('../wp-content/plugins/wielrennen-map-editor/assets/images/outline/"+design_map.layer.outline.type+"/black_"+new_size+"_"+design_map.paper.orientation+".svg')";
		}
